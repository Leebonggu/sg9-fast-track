...
export const SURVEY_CONFIG = {
  ...
  notice: '본 설문은 재건축 추진을 위한 참고자료로만 활용되며, 개인정보는 외부에 공개되지 않습니다.',
  questions: [
    {
      id: 'Q2',
      label: '재건축 필요성',
    ...
    },
    {
      ...
      description: `[ 조합방식 ] 주민 주도 / 수익성 높음 / 조합원 간 갈등 및 사업기간 지연 시 비용 증가로 수익률 하락 가능\n[ 신탁방식 ] 신탁사 주도 / 사업 속도 빠름 / 수익 일부 제한`,
...
// 시트 컬럼명 ↔ config 매핑 헬퍼
export function getSheetColumnName(question: SurveyQuestion): string {
  return question.label;
}

// 플레이스홀더 태그 생성: {{Q2_매우 필요}}
export function getPlaceholderTag(questionId: string, option: string): string {
